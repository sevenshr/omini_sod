...
from .trainer_multi_ddp_sd import OminiModel, get_config, train
from ..pipeline.sd_omini import Condition, convert_to_condition, generate


from ..dataset_sod.data_multi import RGBSalObjDataset, RGBTSalObjDataset, RGBDSalObjDataset, MultiDataset, MultiSampler, DDPSampler, test_dataset, SalObjDataset_val
import cv2
...
def main():
    ...
    trainable_model = OminiModel(
        ...
        # adapter_names=[None, None, "rgb", "depth", "thermal"],
    )
